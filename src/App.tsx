...
■ 방문 예약 시간
- ${currentYear}년 ${currentMonth}월 ${formData.reservationDay}일 ${formData.reservationAmPm} ${formData.reservationTime}시 ${formData.reservationSuffix || ''}
    ...
    <div className="min-h-screen bg-[#F5F5F0] text-[#141414] font-sans p-4 md:p-8 pb-24">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="overflow-x-auto pb-8">
          <div ref={formRef} className="min-w-[800px] max-w-[800px] mx-auto bg-white p-10 shadow-xl">
            {/* Header */}
            <h1 className="text-center text-[40px] font-extrabold mb-10 tracking-[0.2em]">
              센터방문 개통 요청서
            </h1>

            {/* Checkboxes */}
            <div className="flex justify-end gap-6 mb-4 font-bold text-base">
              <div className="flex items-center gap-2 cursor-pointer" onClick={() => setFormData(prev => ({ ...prev, type: '선불' }))}>
                <div className="w-5 h-5 border-2 border-black flex items-center justify-center bg-white">
                  {formData.type === '선불' && <span className="text-black font-bold text-sm leading-none">✓</span>}
                </div>
                선불
              </div>
              <div className="flex items-center gap-2 cursor-pointer" onClick={() => setFormData(prev => ({ ...prev, type: '후불' }))}>
                <div className="w-5 h-5 border-2 border-black flex items-center justify-center bg-white">
                  {formData.type === '후불' && <span className="text-black font-bold text-sm leading-none">✓</span>}
                </div>
                후불
              </div>
              <span className="mx-2">/</span>
              <div className="flex items-center gap-2 cursor-pointer" onClick={() => setFormData(prev => ({ ...prev, category: '신규개통' }))}>
                <div className="w-5 h-5 border-2 border-black flex items-center justify-center bg-white">
                  {formData.category === '신규개통' && <span className="text-black font-bold text-sm leading-none">✓</span>}
                </div>
                신규개통
              </div>
              <div className="flex items-center gap-2 cursor-pointer" onClick={() => setFormData(prev => ({ ...prev, category: '번호이동' }))}>
                <div className="w-5 h-5 border-2 border-black flex items-center justify-center bg-white">
                  {formData.category === '번호이동' && <span className="text-black font-bold text-sm leading-none">✓</span>}
                </div>
                번호이동
              </div>
            </div>
            ...
            {/* Section 1 */}
            <div className="mb-2">
              <p className="font-bold text-lg">▶ 개통 관련 기재란</p>
              <p className="text-base">※ 연체, 미납 정지 단말기, 부가서비스 등 개통 관련 특이사항 입력</p>
            </div>

            <table className="w-full border-collapse border-2 border-black text-center text-base mb-10">
              <tbody>
                {/* Row 1 & 2: 매출자 정보 */}
                <tr>
                  <td rowSpan={2} className="border border-black bg-[#EAEAEA] font-bold w-[25%] py-3">매출자 정보</td>
                  <td className="border border-black bg-[#EAEAEA] font-bold w-[37.5%] py-2">회원번호</td>
                  <td className="border border-black bg-[#EAEAEA] font-bold w-[37.5%] py-2">회원명</td>
                </tr>
                <tr>
                  <td className="border border-black p-0 h-12">
                    <input 
                      ...
                      className="w-full h-full text-center outline-none font-bold bg-transparent"
                    />
                  </td>
                  <td className="border border-black p-0 h-12">
                    <input 
                ...
                {/* Row 3 & 4: 명의자 성명 */}
                <tr>
                  <td className="border border-black bg-[#EAEAEA] font-bold py-2">명의자 성명</td>
                  <td className="border border-black bg-[#EAEAEA] font-bold py-2">명의자 생년월일</td>
                  <td className="border border-black bg-[#EAEAEA] font-bold py-2">명의자 연락번호</td>
                </tr>
                <tr>
                  <td className="border border-black p-0 h-12">
                    <input 
                ...
                {/* Row 5 & 6: 통신망 선택 */}
                <tr>
                  <td className="border border-black bg-[#EAEAEA] font-bold py-2">통신망 선택</td>
                  <td className="border border-black bg-[#EAEAEA] font-bold py-2 leading-tight">
                    가입 요금제<br/><span className="text-sm font-normal">(사전 설명 필수)</span>
                  </td>
                  <td className="border border-black bg-[#EAEAEA] font-bold py-2 leading-tight">
                    (번호이동 시)<br/><span className="text-sm font-normal">현재 사용 번호 / 통신사</span>
                  </td>
                </tr>
                <tr>
                  <td className="border border-black p-0 h-12 font-bold">
                    <div className="flex justify-center gap-6">
                      <div className="flex items-center gap-2 cursor-pointer" onClick={() => setFormData(prev => ({ ...prev, network: 'K망' }))}>
                        <div className="w-4 h-4 border-2 border-black flex items-center justify-center bg-white">
                          {formData.network === 'K망' && <span className="text-black font-bold text-xs leading-none">✓</span>}
                        </div>
                        K망
                      </div>
                      <div className="flex items-center gap-2 cursor-pointer" onClick={() => setFormData(prev => ({ ...prev, network: 'L망' }))}>
                        <div className="w-4 h-4 border-2 border-black flex items-center justify-center bg-white">
                          {formData.network === 'L망' && <span className="text-black font-bold text-xs leading-none">✓</span>}
                        </div>
                        L망
                      </div>
                    </div>
                ...
                {/* Row 7: 방문 예약 시간 */}
                <tr>
                  <td className="border border-black bg-[#EAEAEA] font-bold py-3">방문 예약 시간</td>
                  <td colSpan={2} className="border border-black p-0 h-12 font-bold">
                    <div className="flex items-center w-full h-full px-4 gap-2">
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <input 
                          ...
                          onChange={handleInputChange}
                          className="w-8 text-center outline-none font-bold bg-transparent"
                        />
                        <span>일</span>
                        <select 
                          name="reservationAmPm"
                          value={formData.reservationAmPm}
                          onChange={handleInputChange}
                          className="outline-none font-bold bg-transparent cursor-pointer appearance-none text-center"
                        >
                        ...
                        <input 
                          ...
                          onChange={handleInputChange}
                          onKeyDown={(e) => handleKeyDown(e, 'reservationSuffix')}
                          className="w-12 text-center outline-none font-bold bg-transparent"
                        />
                        <span>시</span>
                      </div>
                      <input 
                        ref={el => inputRefs.current['reservationSuffix'] = el}
                        type="text" 
                        name="reservationSuffix"
                        value={formData.reservationSuffix || ''}
                        onChange={handleInputChange}
                        onKeyDown={(e) => handleKeyDown(e, 'specialNotes')}
                        className="flex-1 text-left outline-none font-bold bg-transparent min-w-[50px]"
                      />
                    </div>
                  </td>
                </tr>
                ...
                {/* Row 8: 특이사항 */}
                <tr>
                  <td className="border border-black bg-[#EAEAEA] font-bold py-3">특이사항</td>
                  <td colSpan={2} className="border border-black p-0 h-12">
                    <input 
                      ...
                      onChange={handleInputChange}
                      onKeyDown={(e) => handleKeyDown(e, 'requesterMemberNo')}
                      className="w-full h-full text-center outline-none font-bold bg-transparent"
                    />
                  </td>
                </tr>
            ...
            {/* Section 2 */}
            <div className="mb-2">
              <p className="font-bold text-lg">▶ 요청 회원 및 센터 기재란</p>
            </div>
            ...
            <table className="w-full border-collapse border-2 border-black text-center text-base mb-10">
              <tbody>
                {/* Row 1-4: 요청 회원 정보 */}
                <tr>
                  <td rowSpan={4} className="border border-black bg-[#EAEAEA] font-bold w-[25%] py-3">요청 회원 정보</td>
                  <td className="border border-black bg-[#EAEAEA] font-bold w-[37.5%] py-2">회원번호</td>
                  <td className="border border-black bg-[#EAEAEA] font-bold w-[37.5%] py-2">회원명</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="border border-black bg-[#EAEAEA] font-bold py-2">소속 센터 / 활동 지역</td>
                  <td className="border border-black bg-[#EAEAEA] font-bold py-2">연락번호</td>
                </tr>
                <tr>
                  <td className="border border-black p-0 h-12">
                    <input 
                ...
                {/* Row 5-6: 개통 처리 정보 */}
                <tr>
                  <td rowSpan={2} className="border border-black bg-[#EAEAEA] font-bold py-3">개통 처리 정보</td>
                  <td className="border border-black bg-[#EAEAEA] font-bold py-2">개통 센터</td>
                  <td className="border border-black bg-[#EAEAEA] font-bold py-2">개통 확정 번호</td>
                </tr>
                <tr>
                  <td className="border border-black p-0 h-12">
                    <input 
            ...
            {/* Footer */}
            <div className="text-base font-bold leading-relaxed mb-6">
              <p className="text-lg mb-2">※ 개통 시 주의사항</p>
              <p>▶ 방문 개통 명의자 본인 확인 후 <span className="text-red-600">개통 본인확인서(필수)</span>를 반드시 작성하여 주세요.</p>
              <p>▶ 다회선 개통 요청 시 개통 의뢰 회원에게 내용 확인 후 개통 진행해주세요.</p>
              <p>▶ 부정영업이 의심이 되는 경우 개통을 거부할 수 있습니다.</p>
              <p className="ml-5 font-normal">- 본인 실사용 외 타인 판매, 양도, 불법 스팸, 보이스피싱 등</p>
            </div>

            {/* Logo */}
            <div className="border-t-[3px] border-double border-gray-400 pt-3 flex justify-end">
              <div className="text-right text-gray-400">
                <p className="font-bold italic text-3xl tracking-tighter">N telecom</p>
                <p className="text-sm">앤텔레콤</p>
              </div>
            </div>
          </div>
        </div>
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-gray-500 flex items-center gap-2">
                          <Calendar size={14} />
                          {item.reservationDay}일 {item.reservationAmPm} {item.reservationTime}시 {item.reservationSuffix || ''}
                        </p>
                      </div>
                    </div>
                  ))
